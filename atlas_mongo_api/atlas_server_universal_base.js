...
const uri = "mongodb+srv://vladyslavsynytskyi1019_db_user:HillelUser2026@cluster0.x9iodwv.mongodb.net/?appName=Cluster0";
...
app.get("/api/carsHillel", async (req, res) => {
  try {
    const collection = req.db.collection("carsHillel"); // Явно указываем имя коллекции
